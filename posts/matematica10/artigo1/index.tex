...
\makeatother
    \definecolor{watermark}{HTML}{FF0000}
...
\begin{center}
\includegraphics[width=0.7\linewidth]{diagrama.pdf}
\end{center}
...
\bibitem[\citeproctext]{ref-livroMatematica10}
